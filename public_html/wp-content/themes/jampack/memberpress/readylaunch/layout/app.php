...
<body <?php body_class('mepr-pro-template mepr-app-layout'); ?>>
  ...
  <div id="page" class="site app-layout">
    <!-- Added account-header-invaders class to the header -->
    <header id="masthead" class="site-header <?php echo isset($is_account_page) ? 'account-header account-header-invaders' : '' ?>">

      <!-- Added space invaders -->
      <div class="invaders-strip">
